...
set timedRun 0
set duration 0
set dataSources {{host localhost parameters {--daqconfig=/user/s800/converged_daq/vmusbdaqconfig.tcl --ctlconfig=/user/s800/converged_daq/vmusbctlconfig.tcl --ring=rawvmusb --sourceid=0} path /scratch/11.0-s800conv/bin/VMUSBReadout provider SSHPipe sourceid 0 wdir /user/s800/converged_daq} {host localhost parameters {--daqconfig=/user/s800/converged_daq/ccusbdaqconfig.tcl --ctlconfig=/user/s800/converged_daq/ccusbctlconfig.tcl --ring=rawccusb --sourceid=1} path /scratch/11.0-s800conv/bin/CCUSBReadout provider SSHPipe sourceid 1 wdir /user/s800/converged_daq}}
